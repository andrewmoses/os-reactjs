...
//    };
     this.state = {
       ...
       shortfeed: [
         ...
         {"model": "feeds.posts", "pk": 2, "fields": {"title": "Harry is alive", "content": "some content", "author": "Venkatesh", "link": "/", "fd_date": "2018-07-09T06:00:00Z"}}
         ]
     };
  }
//  componentDidMount() {
...
//  }
  renderShort(k, shfeed) {
    ...
    return (
      ...
      <a href={'/rj/' + j}>Click to read full</a></p>
    )
  }
  render() {
